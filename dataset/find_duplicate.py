...
for index,trans_file in enumerate(f_list):
    ...
    if(os.path.isfile(full_trans_path)):
        ...
        os.system('python /data/Cross_Cultural_Analysis/embedding/visual/eval.py -a resnet18 --epochs 90 --checkpoint checkpoint/imagenet/resnet18 --root_dir '+ out_frame_path + "/" + trans_file[:-len(opt.transcript_format)] + ' --save_option npy')
